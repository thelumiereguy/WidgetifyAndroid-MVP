            ...
            addLayout(
                Row(this) {
                    ...
                    addChildren(
                        ...
                        Image(this@init) {
                            value = "https://cdn.pixabay.com/photo/2016/11/29/05/45/astronomy-1867616__340.jpg"
                            padding = 12
                            setSizeRatio(15F, 35F)
                        },
                        Image(this@init) {
                            value = "https://killerattitudestatus.in/wp-content/uploads/2019/12/gud-night-images.jpg"
                            padding = 12
